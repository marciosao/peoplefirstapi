...
namespace PeopleFirst.Infra.Data.Repositories
{
    public class HealthCheckRepository : IHealthCheckRepository
    {
        ...
        {
            return await _context.HealthCheck.CountAsync();
        }

        public async Task<IEnumerable<HealthCheck>> ListarPaginadoAsync(int page, int pageSize)
        {
            return await _context.HealthCheck
